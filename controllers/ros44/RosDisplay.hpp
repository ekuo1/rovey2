...
class RosDisplay : public RosDevice
{
  public :
    ...
    bool drawRectangleCallback(webots_ros::display_draw_rectangle::Request &req, webots_ros::display_draw_rectangle::Response &res);
    ...
    bool fillRectangleCallback(webots_ros::display_draw_rectangle::Request &req, webots_ros::display_draw_rectangle::Response &res);
