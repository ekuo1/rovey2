...
class RosSupervisor
{
  public :
    ...
    bool virtualRealityHeadsetGetOrientationCallback(webots_ros::supervisor_virtual_reality_headset_get_orientation::Request &req, webots_ros::supervisor_virtual_reality_headset_get_orientation::Response &res);
    bool virtualRealityHeadsetGetPositionCallback(webots_ros::supervisor_virtual_reality_headset_get_position::Request &req, webots_ros::supervisor_virtual_reality_headset_get_position::Response &res);
    ...
    bool nodeResetPhysicsCallback(webots_ros::node_reset_functions::Request &req, webots_ros::node_reset_functions::Response &res);
    bool nodeRestartControllerCallback(webots_ros::node_reset_functions::Request &req, webots_ros::node_reset_functions::Response &res);
