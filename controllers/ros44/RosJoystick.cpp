...
RosJoystick::RosJoystick(Joystick *joystick, Ros *ros) : RosSensor("joystick", NULL, ros) {
  ...
  mGetNumberOfAxesServer          = RosDevice::rosAdvertiseService((ros->name())+"/joystick/get_number_of_axes", &RosJoystick::getNumberOfAxesCallback);
  mGetNumberOfPovsServer          = RosDevice::rosAdvertiseService((ros->name())+"/joystick/get_number_of_povs", &RosJoystick::getNumberOfPovsCallback);
  mIsConnectedServer              = RosDevice::rosAdvertiseService((ros->name())+"/joystick/is_connected", &RosJoystick::isConnectedCallback);
  mSetConstantForceServer         = RosDevice::rosAdvertiseService((ros->name())+"/joystick/set_constant_force", &RosJoystick::setConstantForceCallback);
  mSetConstantForceDurationServer = RosDevice::rosAdvertiseService((ros->name())+"/joystick/set_constant_force_duration", &RosJoystick::setConstantForceDurationCallback);
  mSetAutoCenteringGainServer     = RosDevice::rosAdvertiseService((ros->name())+"/joystick/set_auto_centering_gain", &RosJoystick::setAutoCenteringCallback);
  mSetResistanceGainServer        = RosDevice::rosAdvertiseService((ros->name())+"/joystick/set_resistance_gain", &RosJoystick::setResistanceGainCallback);
  mSetForceAxisServer             = RosDevice::rosAdvertiseService((ros->name())+"/joystick/set_force_axis", &RosJoystick::setForceAxisCallback);
}
